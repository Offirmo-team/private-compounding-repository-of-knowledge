...
<p align="center">
	<a alt="npm package page"
	  href="https://www.npmjs.com/package/@monorepo-private/practical-logger--node">
		<img alt="npm badge"
		  src="https://img.shields.io/npm/v/@monorepo-private/practical-logger--node.svg">
	</a>
	...
	<a alt="bundle size evaluation"
	  href="https://bundlephobia.com/result?p=@monorepo-private/practical-logger--node">
		<img alt="bundle size badge"
		  src="https://img.shields.io/bundlephobia/minzip/@monorepo-private/practical-logger--node.svg">
	</a>
	<a alt="license"
...
```javascript
import { createLogger } from "@monorepo-private/practical-logger--node"
