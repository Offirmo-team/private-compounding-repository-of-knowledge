...
<p align="center">
	<a alt="npm package page"
	  href="https://www.npmjs.com/package/@monorepo-private/universal-debug-api--node">
		<img alt="npm badge"
		  src="https://img.shields.io/npm/v/@monorepo-private/universal-debug-api--node.svg">
	</a>
	...
	<a alt="bundle size evaluation"
	  href="https://bundlephobia.com/result?p=@monorepo-private/universal-debug-api--node">
		<img alt="bundle size badge"
		  src="https://img.shields.io/bundlephobia/minzip/@monorepo-private/universal-debug-api--node.svg">
	</a>
	<a alt="license"
...
```javascript
import { getLogger, overrideHook } from "@monorepo-private/universal-debug-api--node"
...
Though overrides values accept JSON (correctly escaped), as a convenience because escaping is hard in shell and text
files, numbers are auto-converted and non-JSON values are defaulted to strings:
