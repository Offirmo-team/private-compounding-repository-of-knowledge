...
async function renderCSFV3(
	state: ObservableState,
	render_params: Immutable<RenderParams<Story‿v3>>,
...
async function _renderⵧrender_func(
	state: ObservableState,
	render_params: Immutable<RenderParamsWithRenderFunc<Story‿v3>>,
	container: HTMLElement,
) {
...
async function _renderⵧcomponent(
	state: ObservableState,
