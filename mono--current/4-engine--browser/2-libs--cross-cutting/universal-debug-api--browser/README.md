...
<p align="center">
	<a alt="npm package page"
	  href="https://www.npmjs.com/package/@monorepo-private/universal-debug-api--browser">
		<img alt="npm badge"
		  src="https://img.shields.io/npm/v/@monorepo-private/universal-debug-api--browser.svg">
	</a>
	...
	<a alt="bundle size evaluation"
	  href="https://bundlephobia.com/result?p=@monorepo-private/universal-debug-api--browser">
		<img alt="bundle size badge"
		  src="https://img.shields.io/bundlephobia/minzip/@monorepo-private/universal-debug-api--browser.svg">
	</a>
	<a alt="license"
...
```javascript
import { getLogger, overrideHook } from "@monorepo-private/universal-debug-api--browser"
