import type { LogLevel, LogPayload } from "@monorepo-private/practical-logger--types"

const FONT_FAMILY_BETTER_PROPORTIONAL =
	"font-family: " +
	[
		"-apple-system",
...
const FONT_FAMILY_BETTER_MONOSPACE =
	"font-family: " +
	[
		'"Fira Code"',
...
function add_styled_string(line: string[], chunk: string, ...styles: string[]): string[] {
	...
	return [existing_chunks + "%c" + chunk, ...existing_chunks_styles, styles.join(";") + ";"]
}
