...
<p align="center">
	<a alt="npm package page"
	  href="https://www.npmjs.com/package/@monorepo-private/practical-logger--browser">
		<img alt="npm badge"
		  src="https://img.shields.io/npm/v/@monorepo-private/practical-logger--browser.svg">
	</a>
	...
	<a alt="bundle size evaluation"
	  href="https://bundlephobia.com/result?p=@monorepo-private/practical-logger--browser">
		<img alt="bundle size badge"
		  src="https://img.shields.io/bundlephobia/minzip/@monorepo-private/practical-logger--browser.svg">
	</a>
	<a alt="license"
...
**This lib may not be what you're looking for!** It's a component of the much more complete (and awesome!!)
**[Offirmo’s Universal Debug API](https://universal-debug-api-js.netlify.app/)** (which includes this lib) This lib does
just one thing and does it well: logging in the console. However using the full
[Offirmo’s Universal Debug API](https://universal-debug-api-js.netlify.app/) will gives you:
...
- lower bundle size, no need to bundle the full version!! can be injected locally it through a browser extension,
  Chrome+FF available
...
```javascript
import { createLogger } from '@monorepo-private/practical-logger--browser'
...
Groups are great! However the default behavior is a bit crude. So when the 1st logger is created, it will globally
improve the console.group(...)/groupCollapsed(...)/groupEnd() API, in order to bring:
