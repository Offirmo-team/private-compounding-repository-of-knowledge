...
import { type Armor, getꓽultimate_medium_damage_reduction, ATTACK_VS_DEFENSE_RATIO } from "@tbrpg/logic--armors"
import { type Weapon, getꓽultimate_medium_damage } from "@tbrpg/logic--weapons"
...
export { appraise_power_normalized, appraise_power, appraise_sell_value }
