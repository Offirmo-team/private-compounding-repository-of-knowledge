...
import { rename_avatar, switch_class, equip_item } from "./base.ts"
import { _lose_all_energy, _auto_make_room, _ack_all_engagements } from "./internal.ts"
import { play } from "./play/index.ts"
...
function _autoplay(
	...
	options: Immutable<{ target_good_play_count?: number; target_bad_play_count?: number; DEBUG?: boolean }> = {},
): Immutable<State> {
