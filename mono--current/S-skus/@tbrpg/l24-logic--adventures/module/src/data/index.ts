...
const ENTRIES: Readonly<RawAdventureArchetypeEntry>[] = [
	...
	{ good: true, type: story, hid: "escort", outcome: { health: true } },
	{
		...
		outcome: { armor_or_weapon: true, coin: CoinsGain.lossꘌsmall },
	},
	...
	{ good: true, type: story, hid: "idiot_bandits", outcome: { coin: CoinsGain.gainꘌmedium } },
	{
		...
		type: story,
		hid: "princess",
		outcome: { coin: CoinsGain.gainꘌmedium, improvementⵧarmor_or_weapon: true },
	},
	...
	{ good: true, type: story, hid: "fabric_of_reality", outcome: { mana: true } },
	{
		...
		outcome: { charisma: true, coin: CoinsGain.gainꘌbig, armor_or_weapon: true },
	},
	...
	{ good: true, type: story, hid: "explore_ruins", outcome: { coin: CoinsGain.gainꘌmedium, armor_or_weapon: true } },
	{
		...
		type: story,
		hid: "inspect_sewers",
		outcome: { class_secondary_attribute: true, coin: CoinsGain.gainꘌmedium },
	},
	{
		good: true,
		type: story,
		hid: "explore_catacombs",
		outcome: { coin: CoinsGain.gainꘌmedium, armor_or_weapon: true },
	},
	...
	{ good: true, type: story, hid: "arrow_in_the_knee", outcome: { wisdom: true } },
	{
		...
		outcome: { coin: CoinsGain.gainꘌsmall, class_primary_attribute: true },
	},
...
export { type RawAdventureArchetypeEntry, ENTRIES, i18n_messages }
