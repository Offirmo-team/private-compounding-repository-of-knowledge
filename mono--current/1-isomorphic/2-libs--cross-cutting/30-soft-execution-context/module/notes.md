...
// get_own_function_name(arguments.callee) function get_own_function_name(arguments_callee) { //
https://www.tek-tips.com/viewthread.cfm?qid=1209619 const FN_CODE = arguments_callee.toString() return FN_CODE
.substr(0, FN_CODE.indexOf('(')) // trim off everything after the function name .substr('function '.length) // trim off
"function " }
...
https://stackoverflow.com/questions/1382107/whats-a-good-way-to-extend-error-in-javascript
https://www.ecma-international.org/ecma-262/5.1/#sec-15.11.1 https://github.com/sindresorhus/aggregate-error
...
function WithdrawExperimentException(message) { this.name = 'WithdrawExperimentException'; this.message = message ||
'The experiment was withdrawn and will not run.'; this.stack = (new Error()).stack; }
