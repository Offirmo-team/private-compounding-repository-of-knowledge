...
import type { LogPayload, LogSink } from "@monorepo-private/practical-logger--types"

const LIB = "@monorepo-private/practical-logger--minimal-noop"
...
describe(`${LIB} - index`, () => {
	describe("createLogger()", () => {
		...
		it("should allow passing a custom sink", () => {
			const sink: LogSink = (payload: LogPayload) =>
				void {
					// nothing
				}
